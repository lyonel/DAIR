...
CREATE VIEW search AS SELECT id AS entryid,title AS fulltext FROM entries UNION SELECT id AS entryid,summary AS fulltext FROM entries UNION SELECT entryid,summary AS fulltext FROM notes UNION SELECT entryid,keyword AS fulltext FROM keywords;
